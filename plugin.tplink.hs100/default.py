...
if mode is None:
    ...
    if onoff == "true":
        ...
        li = xbmcgui.ListItem(name, iconImage=addon_icon, thumbnailImage=addon_icon)
    ...
    if onoff2 == "true":
        ...
        li = xbmcgui.ListItem(name2, iconImage=addon_icon, thumbnailImage=addon_icon)
    ...
    if onoff3 == "true":
        ...
        li = xbmcgui.ListItem(name3, iconImage=addon_icon, thumbnailImage=addon_icon)
    ...
    if onoff4 == "true":
        ...
        li = xbmcgui.ListItem(name4, iconImage=addon_icon, thumbnailImage=addon_icon)
    ...
    if onoff5 == "true":
        ...
        li = xbmcgui.ListItem(name5, iconImage=addon_icon, thumbnailImage=addon_icon)
    ...
    url = build_url({'mode': 'settings', 'foldername': __settings__.getLocalizedString(39000)})
    li = xbmcgui.ListItem(__settings__.getLocalizedString(39000), iconImage=addon_icon, thumbnailImage=addon_icon)
    li.setInfo(type='video', infoLabels={'plot': __settings__.getLocalizedString(39000)})
    li.setArt({'fanart': tplink.getAddonInfo('fanart')}) 
    xbmcplugin.addDirectoryItem(handle=addon_handle, url=url, listitem=li, isFolder=False)
